 ...
 */
export const AgentExecutionDisplay = ({ data, availableHeight, childWidth, }) => {
    const [displayMode, setDisplayMode] = React.useState('default');
