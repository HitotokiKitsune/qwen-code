...
export function AgentCreationWizard({ onClose, config, }) {
    ...
    return (_jsx(Box, { flexDirection: "column", children: _jsxs(Box, { borderStyle: "single", borderColor: Colors.Gray, flexDirection: "column", padding: 1, width: "100%", gap: 1, children: [renderStepHeader(), renderStepContent(), renderDebugContent(), renderStepFooter()] }) }));
}
