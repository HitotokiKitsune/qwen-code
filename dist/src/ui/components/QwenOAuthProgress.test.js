...
describe('QwenOAuthProgress', () => {
    ...
    describe('User interactions', () => {
        it('should call onCancel when ESC key is pressed', () => {
            const { stdin } = render(_jsx(QwenOAuthProgress, { onTimeout: mockOnTimeout, onCancel: mockOnCancel, deviceAuth: mockDeviceAuth }));
            // Simulate ESC key press
            stdin.write('\u001b'); // ESC character
            expect(mockOnCancel).toHaveBeenCalledTimes(1);
        });
        it('should call onCancel when ESC is pressed in loading state', () => {
            const { stdin } = render(_jsx(QwenOAuthProgress, { onTimeout: mockOnTimeout, onCancel: mockOnCancel }));
            // Simulate ESC key press
            stdin.write('\u001b'); // ESC character
            expect(mockOnCancel).toHaveBeenCalledTimes(1);
        });
