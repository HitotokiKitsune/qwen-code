...
import { BACKSLASH_ENTER_DETECTION_WINDOW_MS, KITTY_CTRL_C, KITTY_KEYCODE_BACKSPACE, KITTY_KEYCODE_ENTER, KITTY_KEYCODE_NUMPAD_ENTER, KITTY_KEYCODE_TAB, MAX_KITTY_SEQUENCE_LENGTH, } from '../utils/platformConstants.js';
...
export function KeypressProvider({ children, kittyProtocolEnabled, config, }) {
    ...
    useEffect(() => {
        ...
        const parseKittySequence = (sequence) => {
            ...
            if (keyCode === KITTY_KEYCODE_ENTER ||
