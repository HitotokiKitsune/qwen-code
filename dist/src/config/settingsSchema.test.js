...
describe('SettingsSchema', () => {
    describe('SETTINGS_SCHEMA', () => {
        ...
        it('should have accessibility nested properties', () => {
            expect(SETTINGS_SCHEMA.accessibility.properties?.disableLoadingPhrases).toBeDefined();
            expect(SETTINGS_SCHEMA.accessibility.properties?.disableLoadingPhrases.type).toBe('boolean');
        });
        it('should have checkpointing nested properties', () => {
            expect(SETTINGS_SCHEMA.checkpointing.properties?.enabled).toBeDefined();
            expect(SETTINGS_SCHEMA.checkpointing.properties?.enabled.type).toBe('boolean');
        });
        it('should have fileFiltering nested properties', () => {
            expect(SETTINGS_SCHEMA.fileFiltering.properties?.respectGitIgnore).toBeDefined();
            expect(SETTINGS_SCHEMA.fileFiltering.properties?.respectGeminiIgnore).toBeDefined();
            expect(SETTINGS_SCHEMA.fileFiltering.properties?.enableRecursiveFileSearch).toBeDefined();
        });
        ...
        it('should have showInDialog property configured', () => {
            ...
            expect(SETTINGS_SCHEMA.autoConfigureMaxOldSpaceSize.showInDialog).toBe(true);
        });
