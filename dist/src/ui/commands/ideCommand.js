 ...
 */
import { DetectedIde, QWEN_CODE_COMPANION_EXTENSION_NAME, IDEConnectionStatus, getIdeInfo, getIdeInstaller, ideContext, } from '@qwen-code/qwen-code-core';
    ...
    if (!currentIDE || !ideClient.getDetectedIdeDisplayName()) {
        return {
            ...
            action: () => ({
                type: 'message',
                messageType: 'error',
                content: `IDE integration is not supported in your current environment. To use this feature, run Qwen Code in one of these supported IDEs: ${Object.values(DetectedIde)
